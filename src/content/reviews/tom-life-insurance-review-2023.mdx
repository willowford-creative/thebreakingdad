...
rating: 3.5
usageDuration: "Evaluated May 2023"
productCategory: "parenting-kit"
pros:
  - "FCA-regulated and credibly legitimate — Candid Insurance Service Ltd is the underlying company, with 2,300+ Trustpilot reviews averaging 'Excellent'"
  - "The quote service itself is free — they earn from the insurer, not from you, and they sweep a panel of providers in one go"
  - "Pitched specifically at dads (with the 'Polly' equivalent for mums), so the marketing and onboarding tone feel tailored rather than generic"
cons:
  - "Not transparent about which insurers sit on the panel — you don't see who's being compared until you're on the phone with an agent"
  - "Phone-only quote process — there's no online buy-it-yourself option, unlike competitors like Reassured.co.uk"
  - "Gendered 'Tom for dads / Polly for mums' branding is marketing veneer — the underlying service is identical, so it's worth comparing both sides if you're a couple"
