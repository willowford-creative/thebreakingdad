...
rating: 5
usageDuration: "Used for 1 year (and the favourite of several dollhouses we've owned)"
productCategory: "parenting-kit"
pros:
  - "Genuine wooden quality at around 4½ feet tall — feels like a heirloom toy that'll last for years, not a plastic flat-pack that gets binned in six months"
  - "34 pieces of well-crafted wooden furniture across 8 rooms and 4 floors, plus a working lift between levels — endless replay value (we play 'moving house' on repeat)"
  - "Has earned its keep against several other dollhouses we've owned — it's the one Evie still comes back to, and there's space for two kids to play side-by-side"
cons:
  - "Assembly takes around 3 hours, and you'll really want a second pair of hands to hold pieces while balancing — solo is tricky"
  - "It's tall enough that wall-fixing is non-negotiable: kids will lean on the upper floors to peek inside, and without the included fixings it'll tip"
  - "Sized for 12-inch fashion dolls (Barbie-equivalent) only, so smaller dolls or larger figures won't fit the rooms properly"
